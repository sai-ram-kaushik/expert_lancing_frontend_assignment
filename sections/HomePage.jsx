...
const HomePage = () => {
    return (
        <section className="w-full lg:h-[85vh] p-5 lg:p-0">
            <TransitionEffect />
            ...
            <div className="container mx-auto w-full h-full">
                <div className="flex flex-col lg:flex-row items-center justify-center gap-10 w-full h-full">
                    ...
                    <div className="flex flex-col items-center lg:items-start gap-3 lg:w-[45rem] ">
                        <h3 className='lg:leading-[4.5rem] text-center lg:text-start z-[990]'>Tracking Health: Embracing Eco-Friendly Wellness</h3>
